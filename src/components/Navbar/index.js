...
function Navbar() {
    ...
    //context
    const { setPageLoader, loggedInAccount, setAccounts, accounts, setLoggedInAccount, pageLoader, showDetailsPopup, setShowDetailsPopup, data: session, isScrolled, setIsScrolled, showSearchBar, setShowSearchBar, searchQuery, setSearchQuery, showAccountPopup, setShowAccountPopup, router, pathName } = useContext(GlobalContext);
